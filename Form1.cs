...
namespace ZombieGUIGame
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            InitializeComponent();
            RestartGame();
            label2.Text = Properties.Settings.Default.HighScore;
        }
        ...
        private void GameTimmerEvent(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if(Score>tempscore)
                {
                    ...
                    Properties.Settings.Default.HighScore = label2.Text;
                ...
                foreach (Control x in this.Controls)
            {
                ...
                if (x is PictureBox && (string)x.Tag == "reward")
                {
                    if (Shooter.Bounds.IntersectsWith(x.Bounds))
                    {
                        this.Controls.Remove(x);
        ...
        // We Set an Events For Player Facing Movements Through  Events its Work Efficiently as Compare To EZInput
